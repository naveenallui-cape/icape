    ...
    <section id="home" className="w-full bg-background py-12 sm:py-16">
      <div className="w-full px-5 sm:px-8 lg:px-10">
        ...
        <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-5">
          {homeCards.map((card) => {
            const isSchoolLogin = card.href === "/school/login";
            const className =
              "group flex w-full flex-col overflow-hidden rounded-xl border border-accent/50 bg-[color-mix(in_srgb,var(--accent)_3%,white)] shadow-[0_1px_2px_rgba(13,23,59,0.04)] transition duration-300 ease-out hover:z-10 hover:scale-[1.03] hover:shadow-[0_10px_28px_rgba(13,23,59,0.12)]";
